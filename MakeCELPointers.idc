...
static CreatePcodeArray() {
	...
	SetArrayString(pcArray, 0x1400, "EGR/FUEL TANK PRESSURE SOL. LOW");
	SetArrayString(pcArray, 0x1401, "EGR/RFUEL TANK PRESSURE SOL. HIGH");
	...
	SetArrayString(pcArray, 0x2000, "NOX 1 SENSOR PERF. MALF.");
	SetArrayString(pcArray, 0x2001, "NOX 2 SENSOR PERF. MALF.");
	SetArrayString(pcArray, 0x2002, "DPF 1 SENSOR PERF. MALF.");
	SetArrayString(pcArray, 0x2003, "DPF 2 SENSOR PERF. MALF.");
	...
	SetArrayString(pcArray, 0x2200, "NOX SENSOR CIR. MALF.");
	SetArrayString(pcArray, 0x2205, "NOX SENSOR HEATER MALF.");
	SetArrayString(pcArray, 0x220E, "NOX SENSOR HEATER MALF1.");
	SetArrayString(pcArray, 0x220F, "NOX SENSOR HEATER MALF2.");
	...
	SetArrayString(pcArray, 0x225C, "NOX SENSOR PERF.");
	SetArrayString(pcArray, 0x225E, "NOX SENSOR PERF2.");
	SetArrayString(pcArray, 0x2270, "O2 SENSOR SIGNAL BIASED/STUCK LEAN BANK 1 SENSOR 2");
	SetArrayString(pcArray, 0x2271, "O2 SENSOR SIGNAL BIASED/STUCK RICH BANK2 1 SENSOR 2");
	SetArrayString(pcArray, 0x2272, "O2 SENSOR SIGNAL BIASED/STUCK LEAN BANK 2 SENSOR 2");
	SetArrayString(pcArray, 0x2273, "O2 SENSOR SIGNAL BIASED/STUCK RICH BANK2 2 SENSOR 2");
	SetArrayString(pcArray, 0x229E, "NOXA SENSOR CIR. MALF.");
	SetArrayString(pcArray, 0x229F, "NOXB SENSOR CIR. MALF.");
	SetArrayString(pcArray, 0x22A3, "NOX2 SENSOR HEATER MALF.");
	...
	SetArrayString(pcArray, 0x26AD, "ENGINE COOLANT BYPASS VALVE AD");
	SetArrayString(pcArray, 0x26AE, "ENGINE COOLANT BYPASS VALVE AE");
	...
	SetArrayString(pcArray, 0xC29D, "NOX A LOST COMM.");
	SetArrayString(pcArray, 0xC29E, "NOX B LOST COMM.");
